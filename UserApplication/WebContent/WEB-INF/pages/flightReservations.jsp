...
<jsp:useBean id="flightReservationsBean"
	type="pro.artse.user.beans.FlightReservationsBean" scope="request" />
...
<c:set var="flightReservations">
	...
	<tbody>
		<c:forEach items="${flightReservationsBean.getFlightReservations()}"
			var="item">
			<tr>
...
<l:layout>
	...
	<jsp:body>
                                <div
			class="container-fluid --main-table-container">
                                    <div class="row">
                                        <div class='col-12'>
                                            <table
						class="table table-sm --main-table">
                                                ${flightReservations}
                                            </table>
                                        </div>
                                    </div>
